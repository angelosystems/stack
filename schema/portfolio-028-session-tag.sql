-- portfolio-028: session_tag in der Summary (PRD mk-session-lane WP2) —
-- welche Claude-Session die Karte eingestellt hat / daran arbeitet.
-- Basis 027 wortgleich, Spalte hinten angehaengt.
