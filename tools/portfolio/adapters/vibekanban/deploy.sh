#!/bin/bash
# Build + Deploy vibekanban-adapter. Kanonischer Build-Weg (Release-Pipeline WP2):
# stampt version/sha/built_at via -ldflags — `vibekanban-adapter version --json`
...
SRC_DIR="/opt/stack/tools/portfolio/adapters/vibekanban"
REPO_DIR="/opt/stack"
