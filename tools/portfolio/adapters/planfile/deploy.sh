#!/bin/bash
# Build + Deploy planfile-adapter. Kanonischer Build-Weg (Release-Pipeline WP2):
# stampt version/sha/built_at via -ldflags — `planfile-adapter version --json`
...
SRC_DIR="/opt/stack/tools/portfolio/adapters/planfile"
REPO_DIR="/opt/stack"
