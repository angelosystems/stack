...
func runSteward(p *pgxpool.Pool, vkDB string) error {
	...
	query := `
		...
		WHERE (w.archived = 0 OR hex(w.id) IN ('935D9575FDF54F9C816381B9A97DD481', 'B842765043A04994B61AACF51E019956', '05021F1F765846E299B6A36B39DC39F8', '64D07879DB694345BFA59E9D321AAC08'))
